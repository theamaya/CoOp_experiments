...
def load_clip_to_cpu(cfg):
    ...
    if cfg.MODEL.BACKBONE.PRETRAINED:
        ...
        model = clip.build_model(state_dict['model'] or model.state_dict())
...
class CoOp(TrainerX):
    ...
    def build_model(self):
        ...
        if cfg.MODEL.BACKBONE.PRETRAINED:
            print(f"Loading pretrained CLIP (backbone: {cfg.MODEL.BACKBONE.PRETRAINED_PATH})")
        else:
    ...
    def forward_backward(self, batch):   #this is for every batch. where is the for-epoch?
